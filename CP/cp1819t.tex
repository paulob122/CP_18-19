...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{bopCase}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{bopCase}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Bop}\;\Varid{b}\;\Varid{a}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Bop}\;\Varid{a}\;\Varid{op}\;\Varid{b})\mathrel{=}{}\<[25]%
\>[25]{}i_2\;(\Varid{op},(\Varid{a},\Varid{b})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{hiloExpr}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataExpr}\;\Varid{h}\comp \Varid{anaExpr}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Num}\mathbin{+}\Conid{Op}\times\Conid{Expr}\times\Conid{Expr}}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{cataExpr}\;\Varid{g})}}
\\
     \ensuremath{\Conid{Int}}
&
    \ensuremath{\Conid{Num}\mathbin{+}\Conid{Op}\times\Conid{Int}\times\Conid{Int}}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{id}}{\Varid{parseOp}}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{parseOp}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{parseOp}\mathbin{::}(\Conid{Op},(\Conid{Int},\Conid{Int}))\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{parseOp}\;(\Conid{Op}\;\Varid{op},(\Varid{a},\Varid{b}))\mid \Varid{op}\equiv \text{\tt \char34 +\char34}{}\<[37]%
\>[37]{}\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mid \Varid{op}\equiv \text{\tt \char34 -\char34}{}\<[37]%
\>[37]{}\mathrel{=}\Varid{a}\mathbin{-}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mid \Varid{op}\equiv \text{\tt \char34 *\char34}{}\<[37]%
...
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mid \Varid{op}\equiv \text{\tt \char34 mod\char34}\mathrel{=}\Varid{mod}\;\Varid{a}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{10}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{cnvNum}}{\Varid{cnvPar}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cnvNum}\mathbin{::}(\Conid{Num}\;\Varid{a},\Conid{Ord}\;\Varid{a},\Conid{Show}\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{cnvNum}\;\Varid{a}\mid \Varid{a}\mathbin{<}\mathrm{0}\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{show}\;\Varid{a}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mid \Varid{otherwise}\mathrel{=}\Varid{show}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cnvPar}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{cnvPar}\;(\Conid{Op}\;\Varid{op},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \Varid{op}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{37}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{numToComp}}{\Varid{bopToCompile}}\comp \p1\comp \Varid{head}\comp \Varid{readExp}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{numToComp}\;\Varid{a}{}\<[37]%
\>[37]{}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \Varid{show}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{bopToCompile}\;(\Varid{op},(\Varid{s1},\Varid{s2}))\mathrel{=}\Varid{s1}\plus \Varid{s2}\plus [\mskip1.5mu \Varid{opToCodigo}\;\Varid{op}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{opToCodigo}\mathbin{::}\Conid{Op}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{opToCodigo}\;(\Conid{Op}\;\Varid{op})\mid \Varid{op}\equiv \text{\tt \char34 +\char34}\mathrel{=}\text{\tt \char34 ADD\char34}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{op}\equiv \text{\tt \char34 -\char34}\mathrel{=}\text{\tt \char34 SUB\char34}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{op}\equiv \text{\tt \char34 *\char34}\mathrel{=}\text{\tt \char34 MUL\char34}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{op}\equiv \text{\tt \char34 mod\char34}\mathrel{=}\text{\tt \char34 MOD\char34}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Num}\mathbin{+}\Conid{Op}\times[\mskip1.5mu \Conid{String}\mskip1.5mu]\times[\mskip1.5mu \Conid{String}\mskip1.5mu]}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{numToComp}}{\Varid{bopToCompile}}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{exp\char95 test}\mathbin{::}\Conid{Expr}{}\<[E]%
\\
\>[B]{}\Varid{exp\char95 test}\mathrel{=}\Conid{Bop}\;(\Conid{Bop}\;(\Conid{Num}\;\mathrm{5})\;(\Conid{Op}\;\text{\tt \char34 *\char34})\;(\Conid{Num}\;\mathrm{6}))\;(\Conid{Op}\;\text{\tt \char34 +\char34})\;(\Conid{Num}\;(\mathbin{-}\mathrm{1})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{string\char95 codigo\char95 1}\mathbin{::}\Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{string\char95 codigo\char95 1}\mathrel{=}\text{\tt \char34 2~+~3~*~4\char34}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{string\char95 codigo\char95 2}\mathbin{::}\Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{string\char95 codigo\char95 2}\mathrel{=}\text{\tt \char34 2~+~1~*~3~+~4\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=4cm{
    \ensuremath{\Conid{L2D}}
           \ar[d]_-{\ensuremath{\Varid{f}\mathrel{=}\Varid{cataL2D}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outL2D}}}
&
    \ensuremath{\Conid{Unid}\mathbin{+}\Varid{b}\times\Conid{L2D}\times\Conid{L2D}}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}\times\Varid{f}}}
\\
     \ensuremath{\Conid{X}}
&
    \ensuremath{\Conid{Unid}\mathbin{+}\Varid{b}\times\Conid{X}\times\Conid{X}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Varid{casoUnid}}{\Varid{casoComp}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{casoUnid}\;\Varid{a}\mathrel{=}\Conid{Unid}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{casoComp}\;(\Varid{b},(\Varid{l},\Varid{r}))\mathrel{=}\Conid{Comp}\;\Varid{b}\;\Varid{l}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{b}\;\Varid{l}\;\Varid{r})\mathrel{=}i_2\;(\Varid{b},(\Varid{l},\Varid{r})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{collectLeafs}\;(\Conid{Comp}\;\Varid{b}\;\Varid{l}\;\Varid{r})\mathrel{=}(\Varid{collectLeafs}\;\Varid{l})\plus (\Varid{collectLeafs}\;\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{calcOrigins}\;\Varid{fig}\mathrel{=}\Varid{calcOriginsAux}\;(\p2\mathbin{\$}\Varid{fig})\;\Varid{fig}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOriginsAux}\mathbin{::}(\Conid{Float},\Conid{Float})\to ((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOriginsAux}\;\Varid{pos}\;((\Conid{Unid}\;\Varid{ca}),\Varid{orig})\mathrel{=}\Conid{Unid}\;(\Varid{ca},\Varid{pos}){}\<[E]%
\\
\>[B]{}\Varid{calcOriginsAux}\;\Varid{pos}\;(\Conid{Comp}\;\Varid{b}\;(\Conid{Unid}\;\Varid{ca})\;\Varid{r},\Varid{orig})\mathrel{=}\Conid{Comp}\;()\;(\Conid{Unid}\;(\Varid{ca},\Varid{pos}))\;{}\<[E]%
\\
\>[B]{}\hsindent{57}{}\<[57]%
\>[57]{}(\Varid{calcOriginsAux}\;\Varid{proxPosOrig}\;(\Varid{r},\Varid{orig})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{proxPosOrig}\mathrel{=}\Varid{calc}\;\Varid{b}\;\Varid{pos}\;(\Varid{convCoord}\;(\p1\mathbin{\$}\Varid{ca})){}\<[E]%
\\
\>[B]{}\Varid{calcOriginsAux}\;\Varid{pos}\;(\Conid{Comp}\;\Varid{b}\;\Varid{l}\;(\Conid{Unid}\;\Varid{ca}),\Varid{orig})\mathrel{=}\Conid{Comp}\;()\;(\Varid{calcOriginsAux}\;\Varid{proxPosOrig}\;(\Varid{l},\Varid{orig}))\;{}\<[E]%
\\
\>[B]{}\hsindent{57}{}\<[57]%
\>[57]{}(\Conid{Unid}\;(\Varid{ca},\Varid{pos})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{proxPosOrig}\mathrel{=}\Varid{calc}\;\Varid{b}\;\Varid{pos}\;(\Varid{convCoord}\;(\p1\mathbin{\$}\Varid{ca})){}\<[E]%
\\
\>[B]{}\Varid{calcOriginsAux}\;\Varid{pos}\;(\Conid{Comp}\;\Varid{b}\;\Varid{l}\;\Varid{r},\Varid{orig})\mathrel{=}\Conid{Comp}\;()\;(\p1\mathbin{\$}\Varid{fromLeft})\;{}\<[E]%
\\
\>[B]{}\hsindent{49}{}\<[49]%
\>[49]{}(\Varid{calcOriginsAux}\;\Varid{proxPosOrig}\;(\Varid{r},\Varid{orig})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{fromLeft}{}\<[20]%
\>[20]{}\mathrel{=}(\Varid{calcOriginsAux}\;\Varid{pos}\;(\Varid{l},\Varid{orig}),\Varid{pos}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{lastOrigin}\mathrel{=}\p2\;\Varid{fromLeft}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{proxPosOrig}\mathrel{=}\Varid{calc}\;\Varid{b}\;\Varid{pos}\;\Varid{lastOrigin}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{convCoord}\mathbin{::}(\Conid{Int},\Conid{Int})\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{convCoord}\;(\Varid{x},\Varid{y})\mathrel{=}(\Varid{fromIntegral}\;\Varid{x}\mathbin{::}\Conid{Float},\Varid{fromIntegral}\;\Varid{y}\mathbin{::}\Conid{Float}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{Hb})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y})\mathrel{=}((\p1\;\Varid{orig})\mathbin{+}\Varid{box\char95 x},\p2\;\Varid{orig}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{Ht})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y})\mathrel{=}((\p1\;\Varid{orig})\mathbin{+}\Varid{box\char95 x},(\p2\;\Varid{orig})\mathbin{+}\Varid{box\char95 y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{H})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y}){}\<[31]%
\>[31]{}\mathrel{=}((\p1\;\Varid{orig})\mathbin{+}\Varid{box\char95 x},(\p2\;\Varid{orig}){}\<[E]%
\\
\>[31]{}\mathbin{+}(\Varid{fromInteger}\mathbin{\$}\Varid{round}\mathbin{\$}(\Varid{box\char95 y}\mathbin{/}\mathrm{2})\mathbin{*}(\mathrm{10}\mathbin{\uparrow}\mathrm{5}))\mathbin{/}(\mathrm{10.0}\mathbin{\uparrow\uparrow}\mathrm{5})){}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{V})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y}){}\<[31]%
\>[31]{}\mathrel{=}((\p1\;\Varid{orig}){}\<[E]%
\\
\>[31]{}\mathbin{+}(\Varid{fromInteger}\mathbin{\$}\Varid{round}\mathbin{\$}(\Varid{box\char95 x}\mathbin{/}\mathrm{2})\mathbin{*}(\mathrm{10}\mathbin{\uparrow}\mathrm{5}))\mathbin{/}(\mathrm{10.0}\mathbin{\uparrow\uparrow}\mathrm{5}),{}\<[E]%
\\
\>[31]{}\hsindent{2}{}\<[33]%
\>[33]{}(\p2\;\Varid{orig})\mathbin{+}\Varid{box\char95 y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{Ve})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y}){}\<[32]%
\>[32]{}\mathrel{=}((\p1\;\Varid{orig}),(\p2\;\Varid{orig})\mathbin{+}\Varid{box\char95 y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;(\Conid{Vd})\;\Varid{orig}\;(\Varid{box\char95 x},\Varid{box\char95 y}){}\<[32]%
\>[32]{}\mathrel{=}((\p1\;\Varid{orig})\mathbin{+}\Varid{box\char95 x},(\p2\;\Varid{orig})\mathbin{+}\Varid{box\char95 y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\;(\Conid{Unid}\;(\Varid{ca},\Varid{or}))\mathrel{=}[\mskip1.5mu (\Varid{or},\Varid{ca})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\;(\Conid{Comp}\;\Varid{b}\;\Varid{l}\;\Varid{r})\mathrel{=}(\Varid{agrup\char95 caixas}\;\Varid{l})\plus (\Varid{agrup\char95 caixas}\;\Varid{r}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Varid{\Conid{G}.pictures}\comp \Varid{criaPict}\comp \Varid{agrup\char95 caixas}\comp \Varid{calcOrigins}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaPict}\mathbin{::}\Conid{Fig}\to [\mskip1.5mu \Conid{\Conid{G}.Picture}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{criaPict}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{criaPict}\;(\Varid{h}\mathbin{:}\Varid{t}){}\<[19]%
\>[19]{}\mathrel{=}[\mskip1.5mu (\Varid{crCaixa}\;\Varid{or}\;\Varid{width}\;\Varid{height}\;\Varid{text}\;\Varid{col})\mskip1.5mu]\plus (\Varid{criaPict}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{or}{}\<[19]%
\>[19]{}\mathrel{=}(\p1\;\Varid{h}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{width}{}\<[19]%
\>[19]{}\mathrel{=}(\Varid{toFloat}\;(\p1\;(\p1\;(\p2\;\Varid{h})))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{height}{}\<[19]%
\>[19]{}\mathrel{=}(\Varid{toFloat}\;(\p2\;(\p1\;(\p2\;\Varid{h})))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{text}{}\<[19]%
\>[19]{}\mathrel{=}(\p1\;(\p2\;(\p2\;\Varid{h}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{col}{}\<[19]%
\>[19]{}\mathrel{=}(\p2\;(\p2\;(\p2\;\Varid{h}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{toFloat}\;\Varid{x}\mathrel{=}\Varid{fromIntegral}\;\Varid{x}\mathbin{::}\Conid{Float}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\par
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{testeOrigens1}\mathbin{::}(\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo},\Conid{Origem}){}\<[E]%
\\
\>[B]{}\Varid{testeOrigens1}\mathrel{=}(\Varid{caixasHb1},(\mathrm{0},\mathrm{0})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{unidadeA}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}{}\<[E]%
\\
\>[B]{}\Varid{unidadeA}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{200}),(\text{\tt \char34 A\char34},\Varid{col\char95 blue})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{unidadeB}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}{}\<[E]%
\\
\>[B]{}\Varid{unidadeB}\mathrel{=}\Conid{Unid}\;((\mathrm{50},\mathrm{50}),(\text{\tt \char34 B\char34},\Varid{col\char95 green})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasHb1}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}{}\<[E]%
\\
\>[B]{}\Varid{caixasHb1}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;\Varid{unidadeA}\;\Varid{caixasHb2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasHb2}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}{}\<[E]%
\\
\>[B]{}\Varid{caixasHb2}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;\Varid{unidadeA}\;\Varid{unidadeB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasBasico}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}{}\<[E]%
\\
\>[B]{}\Varid{caixasBasico}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;(\Conid{Unid}\;((\mathrm{100},\mathrm{200}),(\text{\tt \char34 A\char34},\Varid{col\char95 blue})))\;(\Conid{Unid}\;((\mathrm{50},\mathrm{50}),(\text{\tt \char34 B\char34},\Varid{col\char95 green}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{c}\;\Varid{x}\;\mathrm{0}{}\<[13]%
\>[13]{}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{c}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{c}\;\Varid{x}\;\Varid{n}\mathbin{+}((\mathbin{-}\mathrm{1})\mathbin{\uparrow}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{x}\mathbin{\uparrow}(\mathrm{2}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{2}))\mathbin{/}((\mathrm{2}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{2})\mathbin{!})\mathrel{=}\Varid{c}\;\Varid{x}\;\Varid{n}\mathbin{+}\Varid{h}\;\Varid{x}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\Varid{x}\;\mathrm{0}\mathrel{=}((\mathbin{-}\Varid{x})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{h}\;\Varid{x}\;\Varid{n})\mathbin{*}(((\mathbin{-}\Varid{x})\mathbin{\uparrow}\mathrm{2})\mathbin{/}((\mathrm{2}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{4})\mathbin{*}(\mathrm{2}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{3})))\mathrel{=}(\Varid{h}\;\Varid{x}\;\Varid{n})\mathbin{*}((\mathbin{-}\Varid{x})\mathbin{\uparrow}\mathrm{2})\mathbin{/}(\Varid{s}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{12}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{s}\;\Varid{n}\mathbin{+}\mathrm{8}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{18}\mathrel{=}\Varid{s}\;\Varid{n}\mathbin{+}\Varid{f}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{18}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{f}\;\Varid{n}\mathbin{+}\mathrm{8}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{c},\Varid{h},\Varid{s},\Varid{f})\mathrel{=}(\Varid{c}\mathbin{+}\Varid{h},\Varid{h}\mathbin{*}(\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\Varid{s}),\Varid{s}\mathbin{+}\Varid{f},\Varid{f}\mathbin{+}\mathrm{8}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{12},\mathrm{18}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{c},\Varid{h},\Varid{s},\Varid{f})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outFS}\;(\Conid{FS}\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t}))\mathrel{=}[\mskip1.5mu (\Varid{x},\Varid{outNode}\;\Varid{y})\mskip1.5mu]\plus \Varid{outFS}\;(\Conid{FS}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;\Varid{x}){}\<[18]%
\>[18]{}\mathrel{=}i_2\;(\Varid{x}){}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=4cm{
    \ensuremath{\Conid{FS}\;\Varid{a}\;\Varid{b}}
           \ar[d]_-{\ensuremath{\Varid{f}\mathrel{=}\Varid{cataFS}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{outFS}}}
&
    \ensuremath{[\mskip1.5mu (\Varid{a},\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b})\mskip1.5mu]}
           \ar[d]^-{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\Varid{f}))}}
\\
     \ensuremath{\Conid{X}}
&
    \ensuremath{[\mskip1.5mu (\Varid{a},\Varid{b}\mathbin{+}\Conid{X})\mskip1.5mu]}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\item \textbf{a)} \ensuremath{\Varid{check}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{Bool}}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;\Varid{geneCheck}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneCheck}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow [\mskip1.5mu (\Varid{a},\Varid{b}+\Conid{Bool})\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{geneCheck}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{geneCheck}\;((\Varid{x},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}\Varid{geneCheck}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{geneCheck}\;((\Varid{x},i_2\;\Varid{b})\mathbin{:}\Varid{t})\mid \Varid{b}\equiv \Conid{False}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}\Varid{geneCheck}\;\Varid{t}\mathrel{\wedge}\neg \;(\Varid{repetidos}\;(\Varid{paraLista}\;((\Varid{x},i_2\;\Varid{b})\mathbin{:}\Varid{t}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{estaNaLista}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow {}\<[27]%
\>[27]{}\Varid{a}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{estaNaLista}\;\anonymous \;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{estaNaLista}\;\Varid{x}\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{x}\equiv \Varid{h}{}\<[33]%
\>[33]{}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mid \Varid{otherwise}\mathrel{=}\Varid{estaNaLista}\;\Varid{x}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{repetidos}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{repetidos}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{repetidos}\;(\Varid{h}\mathbin{:}\Varid{t})\mid \Varid{estaNaLista}\;\Varid{h}\;\Varid{t}\equiv \Conid{True}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}\Varid{repetidos}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{paraLista}\mathbin{::}[\mskip1.5mu (\Varid{a},\Varid{b}+\Varid{c})\mskip1.5mu]\to \Conid{Path}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{paraLista}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{paraLista}\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu \Varid{x}\mskip1.5mu]\plus \Varid{paraLista}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item \textbf{b)} \ensuremath{\Varid{tar}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]}
...
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFS}\;\Varid{geneTar}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneTar}\mathbin{::}[\mskip1.5mu (\Varid{a},\Varid{b}+[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\mskip1.5mu]\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geneTar}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geneTar}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]\plus \Varid{geneTar}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{geneTar}\;((\Varid{a},i_2\;\Varid{l})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{addAllPaths}\;\Varid{a}\;\Varid{l})\plus (\Varid{geneTar}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addAllPaths}\mathbin{::}\Varid{a}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addAllPaths}\;\Varid{a}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addAllPaths}\;\Varid{a}\;((\Varid{list},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu]\plus \Varid{list},\Varid{b})\mskip1.5mu]\plus \Varid{addAllPaths}\;\Varid{a}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item \textbf{c)} \ensuremath{\Varid{untar}\mathbin{::}[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to \Conid{FS}\;\Varid{a}\;\Varid{b}}
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{joinDupDirs}\comp (\Varid{anaFS}\;\Varid{geneUntar}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneUntar}\mathbin{::}[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{b}+([\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geneUntar}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geneUntar}\;(([\mskip1.5mu \mskip1.5mu],\Varid{b})\mathbin{:}\Varid{cauda})\mathrel{=}\Varid{geneUntar}\;\Varid{cauda}{}\<[E]%
\\
\>[B]{}\Varid{geneUntar}\;(([\mskip1.5mu \Varid{x}\mskip1.5mu],\Varid{b})\mathbin{:}\Varid{cauda})\mathrel{=}[\mskip1.5mu (\Varid{x},i_1\;\Varid{b})\mskip1.5mu]\plus \Varid{geneUntar}\;\Varid{cauda}{}\<[E]%
\\
\>[B]{}\Varid{geneUntar}\;(((\Varid{h}\mathbin{:}\Varid{t}),\Varid{b})\mathbin{:}\Varid{cauda})\mathrel{=}[\mskip1.5mu (\Varid{h},i_2\;[\mskip1.5mu (\Varid{t},\Varid{b})\mskip1.5mu])\mskip1.5mu]\plus \Varid{geneUntar}\;\Varid{cauda}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{[\mskip1.5mu (\Varid{a},\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b})\mskip1.5mu]}
        \ar[l]^-{\ensuremath{\Varid{inFS}}}
\\
&
    \ensuremath{[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]}
        \ar[u]^-{\ensuremath{\Varid{f}\mathrel{=}\Varid{anaFS}}}
        \ar[r]_-{\ensuremath{\Varid{g}\mathrel{=}\Varid{geneUntar}}}
&
    \ensuremath{[\mskip1.5mu (\Varid{a},\Varid{b}\mathbin{+}[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\mskip1.5mu]}
        \ar[u]_-{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\Varid{f}))}}
}
\end{eqnarray*}

\item \textbf{d)} \ensuremath{\Varid{find}\mathbin{::}\Varid{a}\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]}
...
\\
\>[B]{}\Varid{find}\;(\Varid{a})\;(\Varid{f})\mathrel{=}\Varid{findAux}\;(\Varid{a})\;(\Varid{cataFS}\;(\Varid{gFind})\;(\Varid{f})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{findAux}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Varid{a}\to [\mskip1.5mu (\Varid{a},\Conid{Path}\;\Varid{a})\mskip1.5mu]\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findAux}\;\Varid{a}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{findAux}\;\Varid{a}\;((\Varid{a1},\Varid{l})\mathbin{:}\Varid{t})\mid (\Varid{a}\equiv \Varid{a1})\mathrel{=}[\mskip1.5mu \Varid{l}\mskip1.5mu]\plus (\Varid{findAux}\;\Varid{a}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{findAux}\;\Varid{a}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gFind}\mathbin{::}[\mskip1.5mu (\Varid{a},\Varid{b}+[\mskip1.5mu (\Varid{a},\Conid{Path}\;\Varid{a})\mskip1.5mu])\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Conid{Path}\;\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gFind}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gFind}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}\Varid{gFind}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{gFind}\;((\Varid{a},i_2\;\Varid{p})\mathbin{:}\Varid{t})\mathrel{=}\Varid{p}\plus (\Varid{gFind}\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item \textbf{e)} \ensuremath{\Varid{new}\mathbin{::}\Conid{Path}\;\Varid{a}\to \Varid{b}\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{FS}\;\Varid{a}\;\Varid{b}}
...
\\
\>[B]{}\Varid{new}\;\Varid{p}\;\Varid{b}\;\Varid{fs}\mathrel{=}\Varid{untar}\;(\Varid{tar}\;(\Varid{fs})\plus [\mskip1.5mu (\Varid{p},\Varid{b})\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gNewCata}\mathbin{::}[\mskip1.5mu (\Varid{a},\Varid{b}+[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\mskip1.5mu]\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNewCata}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNewCata}\;((\Varid{a},i_1\;\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]\plus (\Varid{gNewCata}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\Varid{gNewCata}\;((\Varid{a},i_2\;\Varid{l})\mathbin{:}\Varid{t})\mathrel{=}(\Varid{addAllPaths}\;\Varid{a}\;\Varid{l})\plus (\Varid{gNewCata}\;\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gNewAna}\mathbin{::}[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Varid{b}+[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNewAna}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNewAna}\;(([\mskip1.5mu \Varid{x}\mskip1.5mu],\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}[\mskip1.5mu (\Varid{x},i_1\;\Varid{b})\mskip1.5mu]\plus (\Varid{gNewAna}\;\Varid{t}){}\<[E]%
\\
\>[B]{}\Varid{gNewAna}\;(((\Varid{h}\mathbin{:}\Varid{t}),\Varid{b})\mathbin{:}\Varid{t1})\mathrel{=}[\mskip1.5mu (\Varid{h},i_2\;[\mskip1.5mu (\Varid{t},\Varid{b})\mskip1.5mu])\mskip1.5mu]\plus (\Varid{gNewAna}\;\Varid{t1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item \textbf{f)} \ensuremath{\Varid{cp}\mathbin{::}\Conid{Path}\;\Varid{a}\to \Conid{Path}\;\Varid{a}\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{FS}\;\Varid{a}\;\Varid{b}}
...
\\
\>[B]{}\Varid{cp}\;\Varid{list1}\;\Varid{list2}\;(\Conid{FS}\;\Varid{list3})\mathrel{=}\Varid{new}\;\Varid{list2}\;(\Varid{encontraFile}\;\Varid{list1}\;(\Varid{tar}\;(\Conid{FS}\;\Varid{list3})))\;(\Conid{FS}\;\Varid{list3}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{encontraFile}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Conid{Path}\;\Varid{a}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{encontraFile}\;\Varid{list}\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{t})\mid \Varid{list}\equiv \Varid{x}\mathrel{=}\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\mid \Varid{otherwise}\mathrel{=}\Varid{encontraFile}\;\Varid{list}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item \textbf{g)} \ensuremath{\Varid{rm}\mathbin{::}\Conid{Path}\;\Varid{a}\to \Conid{FS}\;\Varid{a}\;\Varid{b}\to \Conid{FS}\;\Varid{a}\;\Varid{b}}
...
\column{36}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{nav}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow (\Conid{Path}\;\Varid{a},\Conid{FS}\;\Varid{a}\;\Varid{b})\to \Conid{FS}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{nav}\mathrel{=}\Varid{anaFS}\;\Varid{gNav}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gNav}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow (\Conid{Path}\;\Varid{a},\Conid{FS}\;\Varid{a}\;\Varid{b})\to [\mskip1.5mu (\Varid{a},\Varid{b}+(\Conid{Path}\;\Varid{a},\Conid{FS}\;\Varid{a}\;\Varid{b}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNav}\;((\Varid{h}\mathbin{:}\Varid{t}),\Conid{FS}\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{gNav}\;((\Varid{h}\mathbin{:}\Varid{t}),\Conid{FS}\;((\Varid{a},\Conid{File}\;\Varid{b})\mathbin{:}\Varid{t1}))\mid (\Varid{h}\equiv \Varid{a})\mathrel{=}[\mskip1.5mu (\Varid{a},i_1\;\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{36}{}\<[36]%
\>[36]{}\mid \Varid{otherwise}\mathrel{=}\Varid{gNav}\;(\Varid{h}\mathbin{:}\Varid{t},\Conid{FS}\;\Varid{t1}){}\<[E]%
\\
\>[B]{}\Varid{gNav}\;((\Varid{h}\mathbin{:}\Varid{t}),\Conid{FS}\;((\Varid{a},\Conid{Dir}\;\Varid{f})\mathbin{:}\Varid{t1})){}\<[36]%
\>[36]{}\mid (\Varid{h}\equiv \Varid{a})\mathrel{=}[\mskip1.5mu (\Varid{a},i_2\;(\Varid{t},\Varid{f}))\mskip1.5mu]{}\<[E]%
\\
\>[36]{}\mid \Varid{otherwise}\mathrel{=}\Varid{gNav}\;(\Varid{h}\mathbin{:}\Varid{t},\Conid{FS}\;\Varid{t1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
